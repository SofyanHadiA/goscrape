...
func NewUserRepo(db database.IDB) repository.IRepository {
	return productCategoryRepository{
		db: db,
	}
}

func (repo userRepo) CountAll() (int, error) {
...
func (repo userRepo) IsExist(id uuid.UUID) (bool, error) {
...
func (repo userRepo) GetAll(paging utils.Paging) (IModels, error) {
...
func (repo userRepo) Get(id uuid.UUID) (IModel, error) {
...
func (repo userRepo) Insert(model IModel) error {
...
func (repo userRepo) Update(model IModel) error {
...
func (repo userRepo) UpdateUserPhoto(model IModel) error {
...
func (repo userRepo) Delete(model IModel) error {
...
func (repo userRepo) DeleteBulk(users []uuid.UUID) error {
...
func (repo userRepo) ValidatePassword(uid uuid.UUID, password string) (bool, error) {
...
func (repo userRepo) ChangePassword(uid uuid.UUID, password string) error {
